    ...
    <footer className="bg-slate-950 px-4 pb-10 pt-13 text-slate-50 md:px-8">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-[1.6fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-[34ch] text-sm text-slate-400">
            Premium pre-owned cars &amp; motorcycles, inspected and ready to drive. Phnom Penh, Cambodia.
          </p>
        </div>

        <div>
          <h4 className="mb-3.5 text-[0.7rem] font-extrabold uppercase tracking-[0.16em] text-slate-400">Shop</h4>
        ...
        <div>
          <h4 className="mb-3.5 text-[0.7rem] font-extrabold uppercase tracking-[0.16em] text-slate-400">Company</h4>
        ...
        <div>
          <h4 className="mb-3.5 text-[0.7rem] font-extrabold uppercase tracking-[0.16em] text-slate-400">Visit</h4>
          <span className="block py-1 text-sm text-slate-300">📍 Phnom Penh</span>
          <a href="tel:8881234567" className="block py-1 text-sm text-slate-300 hover:text-white">
            (888) 123-4567
          </a>
          <span className="block py-1 text-sm text-slate-300">Mon–Sat · 8am–7pm</span>
        </div>
      </div>
