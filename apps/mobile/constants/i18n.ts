// Central translation dictionary for NR MotorMarket — MOBILE COPY.
//
// This file MIRRORS apps/web/lib/i18n.ts. The web file is the SOURCE OF
// TRUTH for all customer-facing UI copy across English, Khmer, and
// Simplified Chinese. Everything under "shared keys (copied verbatim from
// apps/web/lib/i18n.ts)" below must stay byte-for-byte identical to the web
// dictionary — if you add/change/remove a key there, mirror the change
// here too. Mobile-only keys (drawer/tab labels, alerts) live in their own
// section further down and are NOT present on web.
//
...
export const translations: Record<string, Record<Lang, string>> = {
  // ==========================================================================
  // shared keys (copied verbatim from apps/web/lib/i18n.ts) — do not reword
  // ==========================================================================
  ...
  // ==========================================================================
  // mobile-only keys (not present in apps/web/lib/i18n.ts)
  // ==========================================================================

  // ---- tab bar labels ((tabs)/_layout.tsx) ----
  "nav.feed": { en: "Feed", km: "ព័ត៌មាន", zh: "动态" },
  "nav.post": { en: "Post", km: "ប្រកាស", zh: "发布" },
  "nav.admin": { en: "Admin", km: "អ្នកគ្រប់គ្រង", zh: "管理" },

  // ---- drawer menu (index.tsx) ----
  "drawer.darkMode": { en: "Dark Mode", km: "របៀបងងឹត", zh: "深色模式" },
  "drawer.language": { en: "Language", km: "ភាសា", zh: "语言" },
};
